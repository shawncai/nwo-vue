<template>
  <div class="dashboard-editor-container">
    ...
    <el-dialog :visible.sync="tablevisible" :title="$t('database.repairpercent')" width="80%" top="-10px" center>
      <el-table
        :data="list"
        border
        fit
    ...
    <el-dialog v-if="zhuantype === 1" :visible.sync="tablevisible2" :title="$t('database.repairfinish')" width="80%" top="-10px" center>
    ...
    <el-dialog v-if="zhuantype === 2" :visible.sync="tablevisible2" :title="$t('database.repairfinish2')" width="80%" top="-10px" center>
      <el-button v-waves class="filter-item" type="danger" style="float:left;margin-left: 22%;margin-bottom: 20px" @click="resstart">{{ $t('database.sevendays') }}</el-button>
      <el-date-picker
        v-model="searchQuery.date2"
        :placeholder="$t('database.mounth')"
    ...
    <el-dialog :visible.sync="tablevisible3" :title="$t('database.Dispatching')" width="80%" top="-10px" center>
    ...
    <el-dialog :visible.sync="tablevisible4" :title="$t('database.Dispatching')" width="80%" top="-10px" center>
      <el-button v-waves class="filter-item" type="danger" style="float:left;margin-left: 22%;margin-bottom: 20px" @click="resstart3">{{ $t('database.sevendays') }}</el-button>
      <el-date-picker
        v-model="searchQuery2.date2"
        :placeholder="$t('database.mounth')"

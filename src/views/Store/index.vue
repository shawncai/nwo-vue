  ...
  <div class="tab-container">
    ...
    <div class="app-container">
      <el-table
        ...
        style="width: 100%;">
        <el-table-column :label="$t('Store.id')" prop="id" align="center" width="60">
          <template slot-scope="scope">
            <span>{{ scope.row.id }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('Store.name')" prop="name" min-width="150px" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.name }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('Store.address')" align="center" prop="address" min-width="500px">
          <template slot-scope="scope">
        ...
        <el-table-column :label="$t('Store.stat')" prop="stat" min-width="110px" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.stat | zhuan }}</span>
          </template>
        </el-table-column>
        <el-table-column v-permission="[40]" :label="$t('table.actions')" align="center" min-width="100" class-name="small-padding fixed-width">
          <template slot-scope="scope">
    ...
    <el-dialog :visible.sync="dialogFormVisible" :title="$t('Store.addbranches')" width="30%" center lock-scroll>
    ...
    <el-dialog :visible.sync="dialogFormVisible2" :title="$t('Store.editbranches')" width="30%" center lock-scroll>

<template>
  <div class="app-container">
    <div class="filter-container">
      <el-button v-permission="[76]" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleCreate">{{ $t('table.add') }}</el-button>
    </div>
    <tree-table :data="data" :eval-func="func" :eval-args="args" :expand-all="expandAll" border>
      ...
      <el-table-column v-permission="[76, 80, 81]" :label="$t('area.Operation')" width="240" align="center">
        <template slot-scope="scope">
          <el-button v-permission="[76]" type="primary" size="mini" @click="handleUpdate(scope.row)">{{ $t('table.add') }}</el-button>
          ...
          <el-button v-permission="[81]" type="warning" size="mini" @click="handleEdit(scope.row)">{{ $t('table2.edit') }}</el-button>
        </template>
      </el-table-column>
    </tree-table>
    <el-dialog :visible.sync="dialogFormVisible" :title="$t('area.addAreas')" width="30%" center lock-scroll>
    ...
    <el-dialog :visible.sync="dialogFormVisible2" :title="$t('area.addAreas')" width="30%" center lock-scroll>
    ...
    <el-dialog :visible.sync="dialogFormVisible3" :title="$t('area.editarea')" width="30%" center lock-scroll>

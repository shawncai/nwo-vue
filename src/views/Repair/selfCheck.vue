<template>
  <div class="tab-container">
    ...
    <el-dialog :visible.sync="dialogFormVisible" :title="$t('repair.Addlevel1')" width="30%" center lock-scroll>
    ...
    <el-dialog :visible.sync="dialogFormVisible2" :title="$t('repair.Addlevel2')" width="30%" center lock-scroll>

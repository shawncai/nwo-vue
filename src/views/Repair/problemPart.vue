<template>
  <div class="app-container">
    ...
    <tree-table :data="data" :eval-func="func" :eval-args="args" :expand-all="expandAll" border>
      <el-table-column :label="$t('repair.NameofParts')" align="center">
        <template slot-scope="scope">
          {{ scope.row.name }}
        </template>
      </el-table-column>
      <el-table-column :label="$t('repair.CreationDate')" align="center">
        <template slot-scope="scope">
          {{ scope.row.createTime }}
        </template>
      </el-table-column>
      <el-table-column v-permission="[8, 9]" :label="$t('repair.action')" width="200" align="center">
        <template slot-scope="scope">
    ...
    <el-dialog :visible.sync="dialogFormVisible" :title="$t('repair.Addafirstlevel')" width="30%" center lock-scroll>
    ...
    <el-dialog :visible.sync="dialogFormVisible2" :title="$t('repair.Addasecondarypart')" width="30%" center lock-scroll>

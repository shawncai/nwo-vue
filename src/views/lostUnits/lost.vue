  ...
  <div class="tab-container">
    ...
    <div class="app-container">
      <el-table
        ...
        <el-table-column :label="$t('lostUnits.loststat')" prop="stat" min-width="110px" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.stat | zhuan }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('lostUnits.losttime')" prop="createTime" min-width="110px" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.createTime }}</span>
          </template>
        </el-table-column>
        <el-table-column v-permission="[86]" :label="$t('table.actions')" align="center" min-width="230" class-name="small-padding fixed-width">
          <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      loselist(this.listQuery).then(response => {
    ...
    handleFilter() {
      this.listLoading = true
      searchloselist(this.listQuery).then(res => {

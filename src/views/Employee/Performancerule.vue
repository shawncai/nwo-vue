  ...
  <div class="tab-container">
    <div class="app-container">
      <el-table
        ...
        <el-table-column v-permission="[53, 54]" :label="$t('table.actions')" align="center" min-width="230" class-name="small-padding fixed-width">
          <template slot-scope="scope">
    ...
    <el-dialog :visible.sync="dialogFormVisible" :title="$t('employee.editperformancerules')" width="30%" center lock-scroll>
